...
function updateHeight()
{
	...
	r1.css('top',conW/4 -width/2 - 1);
	r2.css('top', conW/2 - width/2 -2);
	...
	c3.css('margin-left', 3*conW/4 - width/2 -3);
...
$('li').on('click', function(){
	...
	$('.content > p[data-id='+ id +']').css('display', 'block');
	$('.content > img').css('display', 'none');
	$('.content > img[data-id='+ id +']').css('display', 'block');
	$('.content').show();
	$('.reveal').delay(100).animate({width:0}, 800, 'easeOutCubic');
	$('.back').css('display', 'block');
	$('.back').animate({opacity:1},600);
	$('.content > p').css('opacity', 0);
	$('.content > p[data-id='+ id +']').delay(200).animate({opacity:1},600);
	$('.content > img').css('opacity', 0);
	$('.content > img[data-id='+ id +']').animate({opacity:1},600);
